<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:50px;backgroundColor:rgba(255, 255, 255, 1);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:0px 0px 8px 	 #50787c;borderWidth:0px;borderStyle:dotted solid double dashed;borderColor:#ff0000;">
