  ...
  <el-aside class="index-aside" height="100vh" width="210px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role == item.roleName" class="menulist-item"
        style="height:100%;broder:0;background-color:#73a0a5">
        <div class="menulistImg" style="backgroundColor: #50787c;padding:30px 0"
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;"
          background-color="#73a0a5" text-color="#ffffff" active-text-color="#FFFFFF" default-active="0">
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('')"><i v-if="true"
              class="el-icon-s-home" style="color:white"/>首页</el-menu-item>
          <el-submenu :index="1 + ''" :style="menulistBorderBottom">
            <template slot="title">
              <i v-if="true" class="el-icon-user-solid" style="color:white"/>
              <span>个人中心</span>
            </template>
          ...
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('yonghu')"><i v-if="true"
              class="el-icon-s-custom" style="color:white"/>用户信息管理</el-menu-item>
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('jiudianxinxi')"><i v-if="true"
              class="el-icon-s-shop" style="color:white"/>酒店信息管理</el-menu-item>
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('kefangxinxi')"><i v-if="true"
              class="el-icon-s-management" style="color:white"/>客房信息管理</el-menu-item>
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('kefangyuding')"><i v-if="true"
              class="el-icon-s-order" style="color:white"/>客房预订管理</el-menu-item>
          <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('messages')"><i v-if="true"
              class="el-icon-s-comment" style="color:white"/>留言管理</el-menu-item>
          <!-- <el-menu-item index="0" :style="menulistBorderBottom" @click="menuHandler('config')"><i v-if="true"
              class="el-icon-s-picture" style="color:white"/>轮播图管理</el-menu-item> -->
      ...
      this.$nextTick(() => {
        document.querySelectorAll('.menulist .el-menu-item').forEach(el => {
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(80, 120, 124, 1)"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            el.style.backgroundColor = "#73a0a5"
          })
