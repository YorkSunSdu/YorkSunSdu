<template>
	<!-- <el-header>
		<el-menu background-color="#73A0A5" text-color="#FFFFFF" active-text-color="#FFFFFF" mode="horizontal">
	...
	<div class="navbar"
		:style="{ backgroundColor: heads.headBgColor, height: heads.headHeight, lineHeight: heads.headHeight }">
	...
	data() {
		return {
			...
			heads: {
				...
				"headLogoutFontHoverBgColor": "rgba(80, 120, 124, 1)",
				"headFontColor": "rgba(255, 255, 255, 1)",
				"headTitleImg": false, "headHeight": "60px",
