<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒店地区" prop="jiudiandiqu">
          <el-input v-model="ruleForm.jiudiandiqu" 
              placeholder="酒店地区" clearable  :readonly="ro.jiudiandiqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒店地区" prop="jiudiandiqu">
              <el-input v-model="ruleForm.jiudiandiqu" 
                placeholder="酒店地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiudiantupian = true;
          ...
          if(o=='jiudiandiqu'){
            this.ruleForm.jiudiandiqu = obj[o];
	    this.ro.jiudiandiqu = true;
            continue;
          }
          if(o=='jiudiandizhi'){
	...
	this.ruleForm.jiudianjieshao = this.ruleForm.jiudianjieshao.replace(reg,'../../../springbootlvtr5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
